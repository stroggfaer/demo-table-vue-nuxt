...
class Paint {
  ...
  drawLine(points, options) {
    ...
    this.ctx.moveTo(points[0][0] + 0.5, points[0][1] + 0.5); // + 0.5 Решить проблему размытия добавить 1px
  ...
  // Отображает значок в конце ячейки указанной ширины
  ...
  // Рисует путь прямоугольника со скругленными углами
